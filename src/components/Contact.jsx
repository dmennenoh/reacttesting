    ...
    return(
        ...
        <Container>
            <ul className="contact">
                ...
                <li><span className='blueText'>My Resume: </span><a href='https://dmennenoh.netlify.app/assets/resume_dmennenoh.pdf' target='_blank' rel='noopener noreferrer'>My resume - PDF</a></li>
